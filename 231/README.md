<h3><a href="https://codeforces.com/problemset/problem/231/A" target="_blank" rel="noopener noreferrer">A. Team</a></h3>
...
<p>The first input line contains a single integer n (1 ≤ n ≤ 1000) — the number of problems in the contest. Then n lines contain three integers each, each integer is either 0 or 1. If the first number in the line equals 1, then Petya is sure about the problem's solution, otherwise he isn't sure. The second number shows Vasya's view on the solution, the third number shows Tonya's view. The numbers on the lines are separated by spaces.</p>
</div>
...
<ul>
    <li><a href="231/TEAM_question#L1">TEAM_question</a> — problem statement (full text)</li>
    <li><a href="231/TEAM.java">TEAM.java</a> — reference implementation</li>
</ul>
</div>
